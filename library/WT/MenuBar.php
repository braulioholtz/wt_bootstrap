...
class WT_MenuBar {
	...
	public static function getHistoryMenu() {
		$menu = new WT_Menu(WT_I18N::translate('History'), WT_I18N::translate('ipanema_lang').'.php', 'menu-history');
	
		// Build a sortable list of submenu items and then sort it in localized name order
		$menuList = array(
				'ipanema'	=>WT_I18N::translate('ipanema'),
				'daniel' 	=>"Daniel S. Strombeck"
		);
		...
		foreach ($menuList as $menuType => $menuName) {
			switch ($menuType) {
				case 'ipanema':
					$submenu = new WT_Menu($menuName, WT_I18N::translate('ipanema_lang').'.php', 'menu-history_sub');
					$menu->addSubmenu($submenu);
					break;
	
				case 'daniel':
					$submenu = new WT_Menu($menuName, WT_I18N::translate('daniel_lang').'.php', 'menu-history_sub');
					$menu->addSubmenu($submenu);
					break;
